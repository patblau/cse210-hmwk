...
public abstract class Activity
{
    ...
    // <Template method: common flow for every activity.>
    public void Run()
    {
        StartActivity();
        RunCore();          
    ...
    // <Common starting message + ask for duration with short pause.>
    ...
    // <Common ending message with a short pause.>
    ...
    // <Derived classes must provide their core logic.<>
    ...
    //>Countdown animation: 5 4 3 2 1 (erases as it goes).>
