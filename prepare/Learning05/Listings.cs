...
namespace MindfulnessApp
{
    public class ListingActivity : Activity
    {
        ...
        {
            "Who you know that you appreciate?",
            ...
            "What talents and skills do you have that you are grateful for?",
            "What are things you love about nature?",
            "What are traits you see in other, you would want to have?",
            ""
        };
        ...
        protected override void RunCore()
        {
            ...
            // Collect user inputs until time runs out
